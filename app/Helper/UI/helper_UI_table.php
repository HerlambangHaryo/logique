<?php
    ...
    function general_colgroup_thead($DMHA_ID,$AGENT)
    {
		...
		// ------------------------------------------------------------------------- ACTION
			...
			///////////////////////////////////////////////////////////////////////////////// BI Jatim
				elseif($DMHA_ID == 439){ $isi = dmha_439_data_table($AGENT); }
				elseif($DMHA_ID == 443){ $isi = dmha_443_data_table($AGENT); }
				elseif($DMHA_ID == 447){ $isi = dmha_447_data_table($AGENT); }

			///////////////////////////////////////////////////////////////////////////////// Additional
				elseif($DMHA_ID == 452){ $isi = dmha_452_data_table($AGENT); }
        // ------------------------------------------------------------------------- SEND
            $word = $isi;
            return $word;
		//////////////////////////////////////////////////////////////////////////// 		
