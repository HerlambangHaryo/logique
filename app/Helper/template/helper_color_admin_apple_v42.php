...
function color_admin_apple_v42_sidebar($AUTH_ID,$ID_DATA,$DMHA_1,$PARAM_2,$PARAM_3)
            ...
            foreach($model as $row)
            {
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-'.dmha_13_id_check_col($row->dmha_13,'panjang').'">
                        '.dmha_13_generate_pertanyaan($row->dmha_13,$class,$DMHA_1,$DMHA_271,$ID,$AUTH_ID,dmha_13_id_check_col($row->dmha_13,'placeholder'),dmha_13_id_check_col($row->dmha_13,'required'),null,null).'
    ...
    function color_admin_apple_v42_form_wizard($AUTH_ID,$DMHA_1,$DMHA_271,$id_data)
    {
        // ------------------------------------------------------------------------- INITIALIZE
            $isi    = '';
            $class  = 'form-control';
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            foreach ($model2 as $row2) 
                            {
                                ...
                                $attr .= 'data-parsley-group="step-'.$counter.'" ';
                                $attr .= 'data-parsley-required="true" ';
                                // $attr .= 'data-parsley-id="'.$counter2.'" ';
                                // $attr .= 'aria-describedby="parsley-id-'.$counter2.'" ';     
                                // data-parsley-group="step-1" data-parsley-required="true"

                                //$additional_class = 'parsley-error';
                                $additional_class = '';
                                ...
                                if($row2->dmha_431 == $row->dmha_431)
                                {
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-'.(dmha_13_id_check_col($row2->dmha_13,'panjang')+2).'">                                        
                                            '.dmha_13_generate_pertanyaan($row2->dmha_13,$class,$DMHA_1,$DMHA_271,$ID,$AUTH_ID,dmha_13_id_check_col($row2->dmha_13,'placeholder'),dmha_13_id_check_col($row2->dmha_13,'required'),$attr,$additional_class).'
                                        </div>
                                    </div>
                                    ';
                                }
    ...
    function color_admin_apple_v42_flash_message($status,$message,$keterangan)
    {
        // ------------------------------------------------------------------------- INITIALIZE
            $isi    = '';
            $val_keterangan = '';
