...
class WwformController extends Controller
{
    ...
    public function generate()
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            ...
            elseif($dmha_2 == 4)
            {
                if($DMHA_271 == 4)
                {
                    $isi .= color_admin_apple_v42_flash_message(dmha_40_id_check_col(3,'status'),dmha_40_id_check_col(3,'nama'),dmha_40_id_check_col(3,'keterangan'));
                }
    ...
    {       
        ...
        // ------------------------------------------------------------------------- SUBMITTING DATA
            ...
            //////////////////////////////////////////////////////////////////////////////////////////// BI JATIM
                elseif($DMHA_1 == 439) {  $FLASH_MESSAGE = 2;     
                    if($DMHA_271 == 2) {  $FLASH_MESSAGE = 2; dmha_439_create_me($request->all()); }
                    elseif($DMHA_271 == 3) {  $FLASH_MESSAGE = 2; dmha_439_update_me($ID,$request->all()); }
                    elseif($DMHA_271 == 4) {  $FLASH_MESSAGE = 4; dmha_439_softdelete_me($ID); }
                }
                elseif($DMHA_1 == 443) {  $FLASH_MESSAGE = 2;     
                    if($DMHA_271 == 2) {  $FLASH_MESSAGE = 2; dmha_443_create_me($request->all()); }
                    elseif($DMHA_271 == 3) {  $FLASH_MESSAGE = 2; dmha_443_update_me($ID,$request->all()); }
                    elseif($DMHA_271 == 4) {  $FLASH_MESSAGE = 4; dmha_443_softdelete_me($ID); }
                }
                elseif($DMHA_1 == 447) {  $FLASH_MESSAGE = 2;     
                    if($DMHA_271 == 2) {  $FLASH_MESSAGE = 2; dmha_447_create_me($request->all()); }
                    elseif($DMHA_271 == 3) {  $FLASH_MESSAGE = 2; dmha_447_update_me($ID,$request->all()); }
                    elseif($DMHA_271 == 4) {  $FLASH_MESSAGE = 4; dmha_447_softdelete_me($ID); }
                }


            //////////////////////////////////////////////////////////////////////////////////////////// Additional
                elseif($DMHA_1 == 452) {  $FLASH_MESSAGE = 2;     
                    if($DMHA_271 == 2) {  $FLASH_MESSAGE = 2; dmha_452_create_me($request->all()); }
                    elseif($DMHA_271 == 3) {  $FLASH_MESSAGE = 2; dmha_452_update_me($ID,$request->all()); }
                    elseif($DMHA_271 == 4) {  $FLASH_MESSAGE = 4; dmha_452_softdelete_me($ID); }
                }
        // ------------------------------------------------------------------------- SEND
            ...
            // return redirect('Pendaftaran_Para_Suhu');
    }
}
