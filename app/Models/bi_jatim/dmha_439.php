...
class dmha_439 extends Model
{
    ...
    public static function let_me_generate_data_array($AUTH_ID,$ID,$STATUS)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            ...
            {
                $isi = dmha_439::whereNull('deleted_at')
                    ->orderBy('id','desc');
            }
            else
            {
