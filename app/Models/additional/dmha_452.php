...
class dmha_452 extends Model
{
    ...
    public static function let_me_generate_data_array($AUTH_ID,$ID,$STATUS)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            ...
            {
                $isi = dmha_452::whereNull('deleted_at')
                    ->orderBy('id','asc');
            }
            else
            {
